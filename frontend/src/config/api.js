...
export const API = {
  ...
  oauthStart: (provider) => `${BASE_URL}/auth/${provider}`,
  oauthExchange: `${BASE_URL}/auth/oauth/exchange`,
  refreshToken: `${BASE_URL}/account/refresh-token`,
  topTeacher: `${BASE_URL}/top-teacher`,
  publicProfile: (username) => `${BASE_URL}/public-profiles/${encodeURIComponent(username)}`,
  ...
  markNotificationRead: (id) => `${BASE_URL}/account/messages/notifications/${id}/read`,
  ...
  hideCourse: (id) => `${BASE_URL}/admin/courses/${id}/hide`,
  unhideCourse: (id) => `${BASE_URL}/admin/courses/${id}/unhide`,
  mycourses: `${BASE_URL}/account/mycourses`,
  myCourseById: (id) => `${BASE_URL}/account/enrolled-courses/${id}`,
  teachingCourses: `${BASE_URL}/account/teaching-courses`,
  ...
  updateAccountUsername: (id) => `${BASE_URL}/admin/accounts/${id}/username`,
